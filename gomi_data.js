...
const TR={
 ...
 "bins": {
  ...
  "不燃": {
   ...
   "ko": "타지 않는 쓰레기",
   "pt": "Lixo não-incinerável",
   "tl": "Di-nasusunog na basura",
   "es": "Basura no incinerable",
  ...
  "プラ資源": {
   ...
   "ko": "플라스틱 자원",
   "pt": "Plásticos recicláveis",
   "tl": "Plastik na maaaring i-recycle",
   "es": "Plásticos reciclables",
  ...
  "容器包装プラ": {
   ...
   "tl": "Mga lalagyan at pambalot na plastik",
   "es": "Envases y recipientes de plástico",
  ...
  "びん・ペット": {
   ...
   "ko": "빈 병·페트병",
   "pt": "Garrafas e garrafas PET",
   "tl": "Bote at PET bottle",
   "es": "Botellas y botellas PET",
  ...
  "びん缶ペット": {
   ...
   "ko": "빈 캔·빈 병·페트병",
   "pt": "Garrafas, latas e garrafas PET",
   "tl": "Bote, lata, at PET bottle",
   "es": "Botellas, latas y botellas PET",
  ...
  "資源ごみ": {
   ...
   "vi": "Rác tài nguyên",
   "ko": "자원 쓰레기",
   "pt": "Materiais recicláveis",
   "tl": "Mga materyales na maaaring i-recycle",
   "es": "Materiales reciclables",
 ...
 "items": {
  ...
  "cap": {
   ...
   "ko": "페트병 뚜껑",
   "pt": "Tampas de garrafas",
   "tl": "Takip ng bote",
   "es": "Tapas de botellas",
   "id": "Tutup botol",
   "zhHant": "瓶蓋",
  ...
  "milk": {
   ...
   "vi": "Hộp bằng giấy",
   "ko": "종이 팩",
   "pt": "Caixas de papel（leite）",
   "tl": "Karton ng gatas",
   "es": "Cartones de papel（leche）",
   "id": "Karton susu",
   "zhHant": "紙盒包裝",
   "ne": "कागजको प्याकेट"
  },
  ...
  "chawan": {
   ...
   "vi": "Đồ gốm sứ bị vỡ",
   "ko": "깨진 도자기",
   "pt": "Vidros e objetos de porcelana",
   "tl": "Basag na palayok",
   "es": "Vaso / cerámica",
  ...
  "waribashi": {
   ...
   "ko": "사용한 나무젓가락",
   "pt": "Palitos descartáveis usados",
   "tl": "Nagamit na disposable chopsticks",
  ...
  "nuigurumi": {
   ...
   "ko": "낡은 봉제 인형",
   "pt": "Boneco de pelúcia velho",
   "tl": "Lumang stuffed toy",
   "es": "Peluche viejo",
   "id": "Boneka rusak",
   "zhHant": "破損的毛公仔",
  ...
  "pc": {
   ...
   "ko": "다 쓴 노트북 컴퓨터",
   "pt": "Pequenos aparelhos eléctricos",
   "tl": "Maliit na mga gamit sa kuryente",
  ...
  "fan": {
   ...
   "vi": "Quạt mini",
   "ko": "미니 선풍기",
   "pt": "Ventilador pequeno",
   "tl": "Maliit na bentilador",
   "es": "Ventilador pequeño",
  ...
  "abura_raw": {
   ...
   "ko": "다 쓴 식용유",
   "pt": "Óleo de cozinha usado",
   "tl": "Nagamit na mantika",
  ...
  "handyfan": {
   ...
   "ko": "충전식 휴대용 선풍기",
   "pt": "Ventilador de mão recarregável",
   "tl": "Rechargeable na handheld fan",
  ...
  "heattobacco": {
   ...
   "ko": "가열식 담배",
   "pt": "Cigarro aquecido",
   "tl": "Pinainit na sigarilyo",
   "es": "Cigarrillo caliente",
  ...
  "smartphone": {
   ...
   "ko": "휴대전화 단말(스마트폰 포함)",
   "pt": "Telemóvel（smartphone）",
   "tl": "Cellphone（smartphone）",
   "es": "Teléfono móvil（smartphone）",
 ...
 "sources": [
  ...
  {
   "name": "浜松市「ごみと資源物の正しい出し方（家庭ごみ）」ポルトガル語版・スペイン語版・フィリピノ語版／CC BY 2.1 日本（※公式PDFの明らかな誤訳3件は当サイトで訂正：ライター／ストロー／スプレー缶）",
   "url": "https://www.city.hamamatsu.shizuoka.jp/hamapo/09garbage/09_10.html"
  },
  {

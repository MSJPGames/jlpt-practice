...
echo ==================================================
echo  N2 listening - make audio (edge-tts + pydub)
echo ==================================================
echo.
echo Folder: %~dp0
echo.

if not exist "%~dp0make_n2_listening_audio.py" (
  echo [ERROR] make_n2_listening_audio.py is NOT in this folder.
...
if not exist "%~dp0n2_listening_manifest.json" (
  echo [ERROR] n2_listening_manifest.json is NOT in this folder.
  echo         Put the .bat, .py and .json in the SAME folder.
  echo.
  pause
  exit /b 1
...
!PYCMD! "%~dp0make_n2_listening_audio.py"

echo.
echo Done. See the "audio" folder and "_n2_listening_log.txt".

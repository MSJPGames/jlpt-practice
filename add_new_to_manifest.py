...
# -*- coding: utf-8 -*-
"""
n1_listening_manifest.json に新しい12問（n1_q1_41〜46・n1_q5_41〜46）を書き足す。
...
def main():
    ...
    # ── 同名の項目があれば取り除く ───────────────────────────
    def is_new(e):
        return isinstance(e, dict) and isinstance(e.get(fkey), str) and ('n1_q1_4' in e[fkey] or 'n1_q5_4' in e[fkey])
    ...
    print('★ 新しく作られる音声が 12 本だけであることを確かめてください。')
    print('  12本より多いときは、いったん止めて知らせてください。')

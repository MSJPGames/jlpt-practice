 ...
 * ons   呉音・漢音など複数の音読み。[{r:読み, k:呉/漢/慣, w:例語}]
 *       先頭が代表（いちばん普通に使う読み）。on はその代表と同じ。
 *       -ng の字は呉音＝う（よう・おう）／漢音＝い（えい）で対立することが多い。
...
{c:"食", jp:"",   jyut:"sik6",   coda:"k",  on:"しょく", ons:[{r:"しょく",k:"漢",w:"食事 しょくじ"},{r:"じき",k:"呉",w:"断食 だんじき"}], w:"食事",  wr:"しょくじ",   lv:1},
{c:"力", jp:"",   jyut:"lik6",   coda:"k",  on:"りょく", ons:[{r:"りょく",k:"漢",w:"努力 どりょく"},{r:"りき",k:"呉",w:"力士 りきし"}], w:"努力",  wr:"どりょく",   lv:1},
{c:"白", jp:"",   jyut:"baak6",  coda:"k",  on:"はく", ons:[{r:"はく",k:"漢",w:"白紙 はくし"},{r:"びゃく",k:"呉",w:"白夜 びゃくや"}],   w:"白紙",  wr:"はくし",     lv:2},
{c:"客", jp:"",   jyut:"haak3",  coda:"k",  on:"きゃく", ons:[{r:"きゃく",k:"呉",w:"客室 きゃくしつ"},{r:"かく",k:"漢",w:"旅客 りょかく"}], w:"客室",  wr:"きゃくしつ", lv:2},
...
{c:"木", jp:"",   jyut:"muk6",   coda:"k",  on:"もく", ons:[{r:"もく",k:"呉",w:"木曜日 もくようび"},{r:"ぼく",k:"漢",w:"大木 たいぼく"}],   w:"木曜日",wr:"もくようび", lv:1},
{c:"作", jp:"",   jyut:"zok3",   coda:"k",  on:"さく",   w:"作品",  wr:"さくひん",   lv:2},
{c:"式", jp:"",   jyut:"sik1",   coda:"k",  on:"しき",   w:"形式",  wr:"けいしき",   lv:2},
{c:"直", jp:"",   jyut:"zik6",   coda:"k",  on:"ちょく", ons:[{r:"ちょく",k:"漢",w:"直接 ちょくせつ"},{r:"じき",k:"呉",w:"正直 しょうじき"}], w:"直接",  wr:"ちょくせつ", lv:2},
{c:"的", jp:"",   jyut:"dik1",   coda:"k",  on:"てき",   w:"目的",  wr:"もくてき",   lv:2},
{c:"約", jp:"",   jyut:"joek3",  coda:"k",  on:"やく",   w:"約束",  wr:"やくそく",   lv:2},
{c:"石", jp:"",   jyut:"sek6",   coda:"k",  on:"せき", ons:[{r:"せき",k:"漢",w:"石油 せきゆ"},{r:"しゃく",k:"呉",w:"磁石 じしゃく"}],   w:"石油",  wr:"せきゆ",     lv:2},
{c:"竹", jp:"",   jyut:"zuk1",   coda:"k",  on:"ちく",   w:"竹林",  wr:"ちくりん",   lv:3},
{c:"築", jp:"",   jyut:"zuk1",   coda:"k",  on:"ちく",   w:"建築",  wr:"けんちく",   lv:3},
{c:"極", jp:"",   jyut:"gik6",   coda:"k",  on:"きょく", ons:[{r:"きょく",k:"漢",w:"極端 きょくたん"},{r:"ごく",k:"呉",w:"極楽 ごくらく"}], w:"極端",  wr:"きょくたん", lv:3},
{c:"落", jp:"",   jyut:"lok6",   coda:"k",  on:"らく",   w:"落第",  wr:"らくだい",   lv:3},

/* ── -t ───────────────────────────────────────── */
{c:"一", jp:"",   jyut:"jat1",   coda:"t",  on:"いち", ons:[{r:"いち",k:"呉",w:"一番 いちばん"},{r:"いつ",k:"漢",w:"統一 とういつ"}],   w:"一本",  wr:"いっぽん",   lv:1},
{c:"日", jp:"",   jyut:"jat6",   coda:"t",  on:"にち", ons:[{r:"にち",k:"呉",w:"日記 にっき"},{r:"じつ",k:"漢",w:"平日 へいじつ"}],   w:"日記",  wr:"にっき",     lv:1},
{c:"月", jp:"",   jyut:"jyut6",  coda:"t",  on:"げつ", ons:[{r:"げつ",k:"漢",w:"月曜日 げつようび"},{r:"がつ",k:"呉",w:"正月 しょうがつ"}],   w:"月曜日",wr:"げつようび", lv:1},
{c:"發", jp:"発", jyut:"faat3",  coda:"t",  on:"はつ", ons:[{r:"はつ",k:"漢",w:"発表 はっぴょう"},{r:"ほつ",k:"呉",w:"発起人 ほっきにん"}],   w:"発表",  wr:"はっぴょう", lv:1},
...
{c:"質", jp:"",   jyut:"zat1",   coda:"t",  on:"しつ", ons:[{r:"しつ",k:"漢",w:"質問 しつもん"},{r:"しち",k:"呉",w:"質屋 しちや"}],   w:"質問",  wr:"しつもん",   lv:2},
{c:"別", jp:"",   jyut:"bit6",   coda:"t",  on:"べつ",   w:"特別",  wr:"とくべつ",   lv:1},
{c:"活", jp:"",   jyut:"wut6",   coda:"t",  on:"かつ",   w:"活動",  wr:"かつどう",   lv:1},
{c:"物", jp:"",   jyut:"mat6",   coda:"t",  on:"ぶつ", ons:[{r:"ぶつ",k:"漢",w:"物質 ぶっしつ"},{r:"もつ",k:"呉",w:"荷物 にもつ"}],   w:"物質",  wr:"ぶっしつ",   lv:2},
...
{c:"業", jp:"",   jyut:"jip6",   coda:"p",  on:"ぎょう", ons:[{r:"ぎょう",k:"呉",w:"業界 ぎょうかい"},{r:"ごう",k:"漢",w:"自業自得 じごうじとく"}], w:"業界",  wr:"ぎょうかい", lv:2},
...
{c:"立", jp:"",   jyut:"laap6",  coda:"p",  on:"りつ", ons:[{r:"りつ",k:"慣",w:"起立 きりつ"},{r:"りゅう",k:"呉",w:"建立 こんりゅう"}],   w:"建立",  wr:"こんりゅう", lv:3,
  note:"例外。ふつうは「りつ」だが、建立 こんりゅう には規則どおりの古い音が残っている。"},
{c:"雜", jp:"雑", jyut:"zaap6",  coda:"p",  on:"ざつ", ons:[{r:"ざつ",k:"慣",w:"雑誌 ざっし"},{r:"ぞう",k:"呉",w:"雑木林 ぞうきばやし"}],   w:"雑木林",wr:"ぞうきばやし",lv:3,
  note:"例外。「ざつ」が普通だが、雑木林 ぞうきばやし には規則どおりの「ぞう」が残っている。"},
{c:"接", jp:"",   jyut:"zip3",   coda:"p",  on:"せつ", ons:[{r:"せつ",k:"慣",w:"接近 せっきん"}],   w:"接近",  wr:"せっきん",   lv:3,
...
{c:"金", jp:"",   jyut:"gam1",   coda:"m",  on:"きん", ons:[{r:"きん",k:"漢",w:"金曜日 きんようび"},{r:"こん",k:"呉",w:"黄金 おうごん"}],   w:"金曜日",wr:"きんようび", lv:1},
{c:"音", jp:"",   jyut:"jam1",   coda:"m",  on:"おん", ons:[{r:"おん",k:"呉",w:"音楽 おんがく"},{r:"いん",k:"漢",w:"母音 ぼいん"}],   w:"音楽",  wr:"おんがく",   lv:1},
...
{c:"萬", jp:"万", jyut:"maan6",  coda:"n",  on:"まん", ons:[{r:"まん",k:"呉",w:"一万 いちまん"},{r:"ばん",k:"漢",w:"万歳 ばんざい"}],   w:"一万",  wr:"いちまん",   lv:1},
{c:"電", jp:"",    jyut:"din6",   coda:"n",  on:"でん",   w:"電話",  wr:"でんわ",     lv:1},
{c:"文", jp:"",   jyut:"man4",   coda:"n",  on:"ぶん", ons:[{r:"ぶん",k:"呉",w:"文化 ぶんか"},{r:"もん",k:"漢",w:"文字 もんじ"}],   w:"文化",  wr:"ぶんか",     lv:1},
{c:"安", jp:"",   jyut:"on1",    coda:"n",  on:"あん",   w:"安全",  wr:"あんぜん",   lv:1},
{c:"間", jp:"",    jyut:"gaan1",  coda:"n",  on:"かん", ons:[{r:"かん",k:"漢",w:"時間 じかん"},{r:"けん",k:"呉",w:"世間 せけん"}],   w:"時間",  wr:"じかん",     lv:1},
...
{c:"建", jp:"",   jyut:"gin3",   coda:"n",  on:"けん", ons:[{r:"けん",k:"漢",w:"建設 けんせつ"},{r:"こん",k:"呉",w:"建立 こんりゅう"}],   w:"建設",  wr:"けんせつ",   lv:2},
{c:"言", jp:"",   jyut:"jin4",   coda:"n",  on:"げん", ons:[{r:"げん",k:"漢",w:"言語 げんご"},{r:"ごん",k:"呉",w:"無言 むごん"}],   w:"言語",  wr:"げんご",     lv:2},
...
{c:"京", jp:"",   jyut:"ging1",  coda:"ng", on:"きょう", ons:[{r:"きょう",k:"呉",w:"東京 とうきょう"},{r:"けい",k:"漢",w:"京浜 けいひん"}], w:"東京",  wr:"とうきょう", lv:1},
{c:"明", jp:"",   jyut:"ming4",  coda:"ng", on:"めい", ons:[{r:"めい",k:"漢",w:"説明 せつめい"},{r:"みょう",k:"呉",w:"明日 みょうにち"}],   w:"説明",  wr:"せつめい",   lv:1},
{c:"長", jp:"",    jyut:"coeng4", coda:"ng", on:"ちょう", w:"社長",  wr:"しゃちょう", lv:1},
{c:"上", jp:"",   jyut:"soeng6", coda:"ng", on:"じょう", ons:[{r:"じょう",k:"呉",w:"上手 じょうず"},{r:"しょう",k:"漢",w:"上人 しょうにん"}], w:"上手",  wr:"じょうず",   lv:1},
{c:"生", jp:"",   jyut:"sang1",  coda:"ng", on:"せい", ons:[{r:"せい",k:"漢",w:"学生 がくせい"},{r:"しょう",k:"呉",w:"一生 いっしょう"}],   w:"学生",  wr:"がくせい",   lv:1},
...
{c:"行", jp:"",   jyut:"hang4",  coda:"ng", on:"こう", ons:[{r:"こう",k:"漢",w:"銀行 ぎんこう"},{r:"ぎょう",k:"呉",w:"行事 ぎょうじ"}],   w:"銀行",  wr:"ぎんこう",   lv:1},
{c:"成", jp:"",   jyut:"sing4",  coda:"ng", on:"せい", ons:[{r:"せい",k:"漢",w:"成功 せいこう"},{r:"じょう",k:"呉",w:"成就 じょうじゅ"}],   w:"成功",  wr:"せいこう",   lv:2},
{c:"定", jp:"",   jyut:"ding6",  coda:"ng", on:"てい", ons:[{r:"てい",k:"漢",w:"決定 けってい"},{r:"じょう",k:"呉",w:"定規 じょうぎ"}],   w:"決定",  wr:"けってい",   lv:2},
{c:"經", jp:"経", jyut:"ging1",  coda:"ng", on:"けい", ons:[{r:"けい",k:"漢",w:"経済 けいざい"},{r:"きょう",k:"呉",w:"お経 おきょう"}],   w:"経験",  wr:"けいけん",   lv:2},
...
{c:"青", jp:"",   jyut:"cing1",  coda:"ng", on:"せい", ons:[{r:"せい",k:"漢",w:"青年 せいねん"},{r:"しょう",k:"呉",w:"緑青 ろくしょう"}],   w:"青年",  wr:"せいねん",   lv:2},
{c:"兄", jp:"",   jyut:"hing1",  coda:"ng", on:"けい", ons:[{r:"けい",k:"漢",w:"父兄 ふけい"},{r:"きょう",k:"呉",w:"兄弟 きょうだい"}], w:"兄弟",  wr:"きょうだい", lv:3},
